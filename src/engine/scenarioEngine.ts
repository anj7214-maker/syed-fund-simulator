...
export const scenarioCatalog: ScenarioDefinition[] = Object.entries(seeds).flatMap(([moduleKey, rows]) => {
  ...
  return rows.map((row, index) => ({
    ...
    scoreWeightage: row.difficulty === "Beginner" ? 10 : row.difficulty === "Intermediate" ? 15 : row.difficulty === "Advanced" ? 20 : row.difficulty === "Real World Ops" ? 25 : row.difficulty === "NAV Oversight" ? 30 : row.difficulty === "Interview Mode" ? 25 : 35,
